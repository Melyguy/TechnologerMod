...
namespace TechnologerMod.Content.Bosses.PrototypeZR1
...
public override void OnKill()
{
    ...
    // Draw glowmask
    Texture2D glowTexture = ModContent.Request<Texture2D>("TechnologerMod/Content/Bosses/PrototypeZR1/PrototypeZR1Body_Glow").Value;
    spriteBatch.Draw(
        glowTexture,
        drawPos,
        NPC.frame,
