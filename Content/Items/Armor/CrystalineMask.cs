...
namespace TechnologerMod.Content.Items.Armor
{
	...
	public class CrystalineMask : ModItem
	{
		public static readonly int AdditiveGenericDamageBonus = 125;
		public static readonly float RoninDamageIncrease = 9f;
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<CrystalineChestplate>() && legs.type == ModContent.ItemType<CrystalineLeggings>();
		}
        ...
        public override void AddRecipes()
        {
            CreateRecipe()
                ...
                .AddIngredient<GemCoreShards>(20)
