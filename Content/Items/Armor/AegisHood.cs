...
namespace TechnologerMod.Content.Items.Armor
{
	...
	public class AegisHood : ModItem
	{
		public static readonly int AdditiveGenericDamageBonus = 250;
        public static readonly float regenAmounts = 15;
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<AegisRobe>() && legs.type == ModContent.ItemType<AegisLeggings>();
		}
		...
		public override void UpdateArmorSet(Player player) {
			...
			//player.GetModPlayer<GlobalPlayer>().TechnologerDamage += RoninDamageIncrease / 100f; // Increase dealt damage for all weapon classes by 20%
                ...
                ((TechnologerPlayer)modPlayer).regenamount += 10;
