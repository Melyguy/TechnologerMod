...
namespace TechnologerMod.Content.Items.Armor
{
	...
	public class TinkeredGoggles : ModItem
	{
		...
		public override void UpdateArmorSet(Player player) {
			...
			player.GetModPlayer<GlobalPlayer>().TechnologerDamage += AdditiveGenericDamageBonus / 100f; // Increase dealt damage for all weapon classes by 20%
		}
