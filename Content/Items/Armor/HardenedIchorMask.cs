...
namespace TechnologerMod.Content.Items.Armor
{
	...
	public class HardenedIchorMask : ModItem
	{
		public static readonly int AdditiveGenericDamageBonus = 175;
		...
		public override bool IsArmorSet(Item head, Item body, Item legs) {
			return body.type == ModContent.ItemType<ZuuniteChestplate>() && legs.type == ModContent.ItemType<ZuuniteLeggings>();
		}
