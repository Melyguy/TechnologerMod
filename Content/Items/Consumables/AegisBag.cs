using TechnologerMod.Content.Bosses.Haemorrex;
...
namespace TechnologerMod.Content.Items.Consumables
{
	...
	public class AegisBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<VoidGlassItem>(), 1, 30, 45));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<aegisCore>(), 5));
			...
			itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<Haemorrex>()));
		}
	}
}