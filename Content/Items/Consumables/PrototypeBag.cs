...
namespace TechnologerMod.Content.Items.Consumables
{
	...
	public class PrototypeBag : ModItem
	{
		...
		public override void ModifyItemLoot(ItemLoot itemLoot) {
			...
			itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<SparkRifle>(), 3));
			
			// Wood drops (5-15 pieces, guaranteed)
			itemLoot.Add(ItemDropRule.Common(ItemID.WoodenArrow, 1, 5, 15));
			
			// Add coins based on NPC value
			itemLoot.Add(ItemDropRule.CoinsBasedOnNPCValue(ModContent.NPCType<PrototypeZR1Head>()));
		}
	}
}