...
{
	public class AegisTurret : ModItem
	{
...
public override bool CanUseItem(Player player)
{
    ...
    return modPlayer.TinkererGoggles && modPlayer.Focus >= 20;
        ...
        {
            CreateRecipe()
                .AddIngredient<AegisAlloy>(30)
                .AddIngredient<VoidGlassItem>(20)
                .AddIngredient<Phasium>(20)
...
public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
{
    ...
    {
        int projType = ModContent.ProjectileType<PhasiumProj>();
        Projectile.NewProjectile(source, position, velocity, projType, damage, knockback, player.whoAmI);

        // Apply recoil to the player
        //layer.velocity -= velocity.SafeNormalize(Vector2.Zero) * 2f; // Knockback strength
    }
