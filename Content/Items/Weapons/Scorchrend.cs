...
namespace TechnologerMod.Content.Items.Weapons
{
	...
	/// </summary>
	public class Scorchrend : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.damage = 40; // Significantly increased base damage
			Item.knockBack = 8;
...
public override bool CanUseItem(Player player)
{
    ...
    return modPlayer.TinkererGoggles && modPlayer.Focus >= 35;
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
			...
			if (modPlayer.ConsumeFocus(focusCost))
			{
                ...
                else
                {
                    ...
                    int projectileType = ModContent.ProjectileType<FireSlash>();
		...
		public override void AddRecipes() {
             CreateRecipe()
				.AddIngredient<SpringLoadedKatana>()
