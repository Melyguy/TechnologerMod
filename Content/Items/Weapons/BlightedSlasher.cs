...
namespace TechnologerMod.Content.Items.Weapons
{
	...
	/// </summary>
	public class BlightedSlasher : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.useTime = 25; // Faster attack speed
        	...
        	public override bool CanUseItem(Player player)
{
	...
	return base.CanUseItem(player);
        ...
        {
            CreateRecipe()
                .AddIngredient<TinkeredBlade>()
                .AddIngredient<EyesOfTheWyrm>(10)
       ...
       public override void ModifyTooltips(List<TooltipLine> tooltips)
		...
		public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback) {
			if(player.altFunctionUse == 2){
				Projectile.NewProjectile(source, position, velocity, ModContent.ProjectileType<fleshBullet>(), damage, knockback, player.whoAmI);
				return false;
			}
