...
namespace TechnologerMod.Content.Items.Placeable
{
	public class VoidGlassItem : ModItem
	{
		public override void SetStaticDefaults() {
			...
			ItemTrader.ChlorophyteExtractinator.AddOption_OneWay(Type, 1, ItemID.ChlorophyteBar, 5);
		}
		...
		public override void SetDefaults() {
			...
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.VoidGlass>());
			Item.width = 20;
			Item.height = 20;
