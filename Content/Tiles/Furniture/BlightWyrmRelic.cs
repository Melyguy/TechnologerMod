...
namespace TechnologerMod.Content.Tiles.Furniture
{
	...
	public class BlightWyrmRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TechnologerMod/Content/Tiles/Furniture/BlightWyrmRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TechnologerMod/Content/Tiles/Furniture/RelicPedestal";
	...
	// Your tile code would then inherit from the ForestGuardianRelic class (which you should make abstract) and should look like this:
	/*
	public class MyBossRelic : ForestGuardianRelic
	{
